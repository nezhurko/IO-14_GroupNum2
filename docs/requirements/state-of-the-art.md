...
<b>Модель даних DDF <a href="https://support.google.com/drive/answer/6283888">(9)</a> — це спосіб упорядкування даних і визначення зв’язку частин даних між собою. Використовується для ідентифікації записів. Кожен набір даних DDF визначає п’ять наборів даних: поняття, метадані, сутності, точки даних і синоніми.
